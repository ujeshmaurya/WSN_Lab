...
Name: UJESH MAURYA
ID: 2015UCP1338
Problem: Create Hidden & Exposed terminal scenario of wireless network.
Analyze the no. of dropped packets in both scenario.
*/
...
void experiment(bool enableRtsCts)
{
...
int main (int argc, char *argv[])
{
  ...
  cout<<endl<<"RtsCts is disabled"<<endl<<endl;;
  experiment (false);
  cout<<endl<<"RtsCts is enabled"<<endl<<endl;
  experiment (true);
